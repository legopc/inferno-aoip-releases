...
Review edition for audio playback — April 2026

This document lists all 59 open improvements to the Inferno AoIP appliance, sorted by priority. Each improvement describes what it does, why it matters, and any reasons to delay or skip it.

**Priority levels:** Critical means blocking or a security risk. High means significant operational pain or safety risk. Medium means a meaningful improvement. Low means a nice-to-have.

**Difficulty:** Easy means under two hours. Medium means about half a day. Hard means multiple days of work.

## Critical Priority

### Bug Fix BUG-05 — SELinux unlabeled_t on /var/home/core/.ssh → SSH key auth fails

**Priority:** Critical | **Difficulty:** Easy (under 2 hours) | **Risk:** Low
...
**Priority:** High | **Difficulty:** Easy (under 2 hours) | **Risk:** Low
...
**Priority:** High | **Difficulty:** Easy (under 2 hours) | **Risk:** Medium
...
**Priority:** High | **Difficulty:** Medium (about half a day) | **Risk:** Low
...
**Priority:** High | **Difficulty:** Medium (about half a day) | **Risk:** Medium
...
**Priority:** Medium | **Difficulty:** Easy (under 2 hours) | **Risk:** Low
...
**Priority:** Medium | **Difficulty:** Medium (about half a day) | **Risk:** Medium
...
**Priority:** Medium | **Difficulty:** Medium (about half a day) | **Risk:** Low
...
**Priority:** Medium | **Difficulty:** Hard (multiple days) | **Risk:** Medium
...
**Priority:** Medium | **Difficulty:** Hard (multiple days) | **Risk:** High
...
**Priority:** Medium | **Difficulty:** Hard (multiple days) | **Risk:** Low
...
**Priority:** Low | **Difficulty:** Easy (under 2 hours) | **Risk:** Low
...
**Priority:** Low | **Difficulty:** Medium (about half a day) | **Risk:** Low
...
**Priority:** Low | **Difficulty:** Hard (multiple days) | **Risk:** Low
...
End of open improvements — 59 items total.