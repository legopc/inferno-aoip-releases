...
> **Total items:** 57 (1 bug fix + 56 improvements)  
...
| 20 | Upgrade | Upgrade History in Cockpit | 🟢 Low | Easy (<2h) | Low | BUG-01 |
...
| 18 | Upgrade | Upload Resume / Chunked Upload | 🟢 Low | Hard (multi-day) | Medium | BUG-01 |
...
|---|---|---|---|---|---|
| BUG-01 | `apply-update.sh`: missing `skopeo copy` command | 🔴 Critical | Easy (<2h) | Low | None |
...
| 16 | Pre-upgrade version check in `apply-update.sh` | 🟡 Medium | Easy (<2h) | Low | BUG-01 |
| 17 | Auto-rollback on failed boot | 🟠 High | Medium (half-day) | Medium | BUG-01, 15 |
| 18 | Upload resume / chunked upload | 🟢 Low | Hard (multi-day) | Medium | BUG-01 |
| 19 | Delta / layer-based upgrades via local OCI registry | 🟡 Medium | Medium (half-day) | Low | BUG-01 |
| 20 | Upgrade history in Cockpit | 🟢 Low | Easy (<2h) | Low | BUG-01 |
...
| ID | Title | Importance | Difficulty | Risk | Prerequisites |
|---|---|---|---|---|---|
| 47 | Cockpit: surface node identity | 🟠 High | Easy (<2h) | Low | None |
| 48 | Health HTTP endpoint | 🟠 High | Easy (<2h) | Low | None |
| 49 | mDNS alias `inferno.local` | 🟡 Medium | Easy (<2h) | Medium | None |
| 50 | Upgrade audit log with rollback events | 🟠 High | Easy (<2h) | Low | 17 |
| 51 | Cockpit: `bootc status` panel | 🟠 High | Easy (<2h) | Low | None |
| 52 | Cockpit: one-click rollback button | 🟡 Medium | Medium (half-day) | Medium | 50, 51 |
| 53 | Cockpit: mode switcher (Spotify ↔ AUX) | 🟡 Medium | Medium (half-day) | Medium | None |
| 54 | Cockpit: Dante device status | 🟠 High | Easy (<2h) | Low | 47 |
| 55 | Cockpit: PTP clock status | 🟡 Medium | Medium (half-day) | Low | None |
